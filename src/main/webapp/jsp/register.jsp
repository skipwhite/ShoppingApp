  ...
  <div class="container-fluid">
    ...
    <main class="container p-5">
		<form action="<c:out value='${ctx}'/>/register" method="post">
		        ...
		        <div class="form-group">
		            <input autocomplete="off" autofocus class="form-control" name="name" placeholder="姓名" type="text" value="${name}">
		        </div>
		        <div class="form-group">
		            <input autocomplete="off" autofocus class="form-control" name="email" placeholder="Email" type="text" value="${email}">
		        </div>
		        <div class="form-group">
		            <input autocomplete="off" autofocus class="form-control" name="password" placeholder="密碼" type="text">
		        </div>
		        <div class="form-group">
		            <input autocomplete="off" autofocus class="form-control" name="password2" placeholder="再次確認密碼" type="text">
		        </div>
